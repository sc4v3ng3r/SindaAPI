...
/**
 * Esta classe tem como objetivo interpretar as páginas web do sistema SINDA
 * e transformar seus dados para o modelo JAVA.
 * @author scavenger
 */
public class SindaPcdParser {
    
    private SindaWebpageFetcher m_fetcher = new SindaWebpageFetcher() ;
    ...
    /**
     * Este método interpreta a página Html das listas de PCD's do
     * site do Sinda e retorna a lista das PCD's todas com os dados
     * básicos configurados.
     * Os dados básicos são: Id, Estação e UF
    ...
    /**
     * Esse interpreta a página do sinda que possui informações
     * de localidade e período de funcionamento de uma determinada
     * PCD. Ele retorna a PCD com seus dados completos caso eles existam
     * na página.
     * @param htmlDoc Página html do sinda para ser interpretada.
    ...
    /**
     * Interpreta uma página web do sistema sinda com uma tabela de dados
     * de uma determinada PCD retorna um List<String> contendo a descrição dos
     * sensores ou "índices" da PCD ATUAL.
     * @param htmlDoc
     * @return 
     */
    ...
    /**
     * Interpreta uma página web do sistema sinda com uma tabela de dados
     * de uma determinada PCD e retorna um List<PcdData> com os dados extraídos
     * da página. A ordem dos dados é extraída na mesma ordem dos índices dos 
     * contadores da PCD
                ...
                while( rowsIterator.hasNext() ) {
                    ...
                    */
                    ...
                    while( dataValuesIterator.hasNext() ) {
                        ...
                        /*
                            somente para efeito de debug
                        System.out.println( indexes.get(indexCounter) + " : " + value  );
                        indexCounter+=1;*/
                        
                    }
                    
                    //System.out.println( "SPLIT VECTOR SIZE: " + dataStringValues.split("#").length );
    ...
    /**
     * Retorna uma lista de strings com a descrição das colunas
     * dos sensores de uma PCD
     * @param indexesRow
     * @return 
     */
    ...
    /**
     * Obtém ambos os períodos: Inicial & Final de uma PCD.
     * Caso os períodos não sejam fornecidos pelo site do sinda
     * a lista de períodos retorna vazia.
